...
func TestAdd(t *testing.T) {
	...
	data := pos_models.Change{
		Foundation: base_models.Foundation{Model: gorm.Model{}, Name: "Change", Type: "Change", Stage: "added", Maker: "maker", Checker: "checker", Approver: "approver", Description: "Change", Status: "", WorkflowLevels: 0, SyncToken: 0, Version: 0, Enabled: 0, Locale: "", Events: []byte{}},
	}
	data.ID = uint(ref)
	got := New().Add(&data)
	require.NotNilf(t, got.Change, "Expected non Nil but received %v  instead", got.ChangeList)
...
func TestDelete(t *testing.T) {
	...
	require.LessOrEqual(t, len(got.ChangeList), 0, "Expected non Nil but received %v  instead", got.ChangeList)
}
