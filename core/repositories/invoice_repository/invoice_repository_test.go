...
func TestAdd(t *testing.T) {
	...
	data := pos_models.Invoice{
		Foundation: base_models.Foundation{Model: gorm.Model{}, Name: "Invoice", Type: "Invoice", Stage: "added", Maker: "maker", Checker: "checker", Approver: "approver", Description: "Invoice", Status: "", WorkflowLevels: 0, SyncToken: 0, Version: 0, Enabled: 0, Locale: "", Events: []byte{}},
	}
	data.ID = uint(ref)
	got := New().Add(&data)
	require.NotNilf(t, got.Invoice, "Expected non Nil but received %v  instead", got.InvoiceList)
...
func TestDelete(t *testing.T) {
	...
	require.LessOrEqual(t, len(got.InvoiceList), 0, "Expected non Nil but received %v  instead", got.InvoiceList)
}
