...
func TestAdd(t *testing.T) {
	...
	data := pos_models.Marketing{
		Foundation: base_models.Foundation{Model: gorm.Model{}, Name: "Marketing", Type: "Marketing", Stage: "added", Maker: "maker", Checker: "checker", Approver: "approver", Description: "Marketing", Status: "", WorkflowLevels: 0, SyncToken: 0, Version: 0, Enabled: 0, Locale: "", Events: []byte{}},
	}
	data.ID = uint(ref)
	got := New().Add(&data)
	require.NotNilf(t, got.Marketing, "Expected non Nil but received %v  instead", got.MarketingList)
...
func TestDelete(t *testing.T) {
	...
	require.LessOrEqual(t, len(got.MarketingList), 0, "Expected non Nil but received %v  instead", got.MarketingList)
}
