...
func _generateEmails(h hermes.Hermes, email hermes.Email, example string) {
...
type _smtpAuthentication struct {
	Server         string
	Port           int
	SenderEmail    string
...
type _sendOptions struct {
	To      string
	Subject string
}

// send sends the email
func _send(smtpConfig smtpAuthentication, options sendOptions, htmlBody string, txtBody string) error {
