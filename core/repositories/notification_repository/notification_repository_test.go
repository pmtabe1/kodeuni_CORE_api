...
func TestAdd(t *testing.T) {
	...
	data := subscription_models.Notification{
		Foundation: base_models.Foundation{Model: gorm.Model{}, Name: "Notification", Type: "Notification", Stage: "added", Maker: "maker", Checker: "checker", Approver: "approver", Description: "Notification", Status: "", WorkflowLevels: 0, SyncToken: 0, Version: 0, Enabled: 0, Locale: "", Events: []byte{}},
	}
	data.ID = uint(ref)
	got := New().Add(&data)
	require.NotNilf(t, got.Notification, "Expected non Nil but received %v  instead", got.NotificationList)
...
func TestDelete(t *testing.T) {
	...
	require.LessOrEqual(t, len(got.NotificationList), 0, "Expected non Nil but received %v  instead", got.NotificationList)
}
