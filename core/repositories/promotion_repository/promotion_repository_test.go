...
func TestAdd(t *testing.T) {
	...
	data := pos_models.Promotion{
		Foundation: base_models.Foundation{Model: gorm.Model{}, Name: "Promotion", Type: "Promotion", Stage: "added", Maker: "maker", Checker: "checker", Approver: "approver", Description: "Promotion", Status: "", WorkflowLevels: 0, SyncToken: 0, Version: 0, Enabled: 0, Locale: "", Events: []byte{}},
	}
	data.ID = uint(ref)
	got := New().Add(&data)
	require.NotNilf(t, got.Promotion, "Expected non Nil but received %v  instead", got.PromotionList)
...
func TestDelete(t *testing.T) {
	...
	require.LessOrEqual(t, len(got.PromotionList), 0, "Expected non Nil but received %v  instead", got.PromotionList)
}
