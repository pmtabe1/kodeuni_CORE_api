...
func TestAdd(t *testing.T) {
	...
	data := pos_models.Inventory{
		Foundation: base_models.Foundation{Model: gorm.Model{}, Name: "Inventory", Type: "Inventory", Stage: "added", Maker: "maker", Checker: "checker", Approver: "approver", Description: "Inventory", Status: "", WorkflowLevels: 0, SyncToken: 0, Version: 0, Enabled: 0, Locale: "", Events: []byte{}},
	}
	data.ID = uint(ref)
	got := New().Add(&data)
	require.NotNilf(t, got.Inventory, "Expected non Nil but received %v  instead", got.InventoryList)
...
func TestDelete(t *testing.T) {
	...
	require.LessOrEqual(t, len(got.InventoryList), 0, "Expected non Nil but received %v  instead", got.InventoryList)
}
