...
func TestAdd(t *testing.T) {
	...
	data := pos_models.OrderItem{
		Foundation: base_models.Foundation{Model: gorm.Model{}, Name: "OrderItem", Type: "OrderItem", Stage: "added", Maker: "maker", Checker: "checker", Approver: "approver", Description: "OrderItem", Status: "", WorkflowLevels: 0, SyncToken: 0, Version: 0, Enabled: 0, Locale: "", Events: []byte{}},
	}
	data.ID = uint(ref)
	got := New().Add(&data)
	require.NotNilf(t, got.OrderItem, "Expected non Nil but received %v  instead", got.OrderItemList)
...
func TestDelete(t *testing.T) {
	...
	require.LessOrEqual(t, len(got.OrderItemList), 0, "Expected non Nil but received %v  instead", got.OrderItemList)
}
