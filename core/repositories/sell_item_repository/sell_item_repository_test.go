...
func TestAdd(t *testing.T) {
	...
	data := pos_models.SellItem{
		Foundation: base_models.Foundation{Model: gorm.Model{}, Name: "SellItem", Type: "SellItem", Stage: "added", Maker: "maker", Checker: "checker", Approver: "approver", Description: "SellItem", Status: "", WorkflowLevels: 0, SyncToken: 0, Version: 0, Enabled: 0, Locale: "", Events: []byte{}},
	}
	data.ID = uint(ref)
	got := New().Add(&data)
	require.NotNilf(t, got.SellItem, "Expected non Nil but received %v  instead", got.SellItemList)
...
func TestDelete(t *testing.T) {
	...
	require.LessOrEqual(t, len(got.SellItemList), 0, "Expected non Nil but received %v  instead", got.SellItemList)
}
