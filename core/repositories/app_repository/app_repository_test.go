...
func TestAdd(t *testing.T) {
	...
	data := pos_models.App{
		Foundation: base_models.Foundation{Model: gorm.Model{}, Name: "App", Type: "App", Stage: "added", Maker: "maker", Checker: "checker", Approver: "approver", Description: "App", Status: "", WorkflowLevels: 0, SyncToken: 0, Version: 0, Enabled: 0, Locale: "", Events: []byte{}},
		AppStoreID: 0,
	}
	data.ID = uint(ref)
	got := New().Add(&data)
	require.NotNilf(t, got.App, "Expected non Nil but received %v  instead", got.AppList)
...
func TestDelete(t *testing.T) {
	...
	require.LessOrEqual(t, len(got.AppList), 0, "Expected non Nil but received %v  instead", got.AppList)
}