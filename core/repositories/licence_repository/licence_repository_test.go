...
func TestAdd(t *testing.T) {
	...
	data := subscription_models.Licence{
		Foundation: base_models.Foundation{Model: gorm.Model{}, Name: "Licence", Type: "Licence", Stage: "added", Maker: "maker", Checker: "checker", Approver: "approver", Description: "Licence", Status: "", WorkflowLevels: 0, SyncToken: 0, Version: 0, Enabled: 0, Locale: "", Events: []byte{}},
	}
	data.ID = uint(ref)
	got := New().Add(&data)
	require.NotNilf(t, got.Licence, "Expected non Nil but received %v  instead", got.LicenceList)
...
func TestDelete(t *testing.T) {
	...
	require.LessOrEqual(t, len(got.LicenceList), 0, "Expected non Nil but received %v  instead", got.LicenceList)
}
