...
func TestAdd(t *testing.T) {
	...
	data := pos_models.Till{
		Foundation: base_models.Foundation{Model: gorm.Model{}, Name: "Till", Type: "Till", Stage: "added", Maker: "maker", Checker: "checker", Approver: "approver", Description: "Till", Status: "", WorkflowLevels: 0, SyncToken: 0, Version: 0, Enabled: 0, Locale: "", Events: []byte{}},
	}
	data.ID = uint(ref)
	got := New().Add(&data)
	require.NotNilf(t, got.Till, "Expected non Nil but received %v  instead", got.TillList)
...
func TestDelete(t *testing.T) {
	...
	require.LessOrEqual(t, len(got.TillList), 0, "Expected non Nil but received %v  instead", got.TillList)
}
