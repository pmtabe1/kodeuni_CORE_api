...
func TestAdd(t *testing.T) {
	...
	data := pos_models.Store{
		Foundation: base_models.Foundation{Model: gorm.Model{}, Name: "Store", Type: "Store", Stage: "added", Maker: "maker", Checker: "checker", Approver: "approver", Description: "Store", Status: "", WorkflowLevels: 0, SyncToken: 0, Version: 0, Enabled: 0, Locale: "", Events: []byte{}},
	}
	data.ID = uint(ref)
	got := New().Add(&data)
	require.NotNilf(t, got.Store, "Expected non Nil but received %v  instead", got.StoreList)
...
func TestDelete(t *testing.T) {
	...
	require.LessOrEqual(t, len(got.StoreList), 0, "Expected non Nil but received %v  instead", got.StoreList)
}
