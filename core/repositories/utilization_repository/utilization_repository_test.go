package utilization_repository
...
func TestAdd(t *testing.T) {
	...
	data := pos_models.Utilization{
		Foundation:    base_models.Foundation{Model: gorm.Model{}, Name: "Utilization", Type: "Utilization", Stage: "added", Maker: "maker", Checker: "checker", Approver: "approver", Description: "Utilization", Status: "", WorkflowLevels: 0, SyncToken: 0, Version: 0, Enabled: 0, Locale: "", Events: []byte{}},
		Amount:        20000,
		ConsumptionID: 0,
	...
	data.ID = uint(ref)
	got := New().Add(&data)
	require.NotNilf(t, got.Utilization, "Expected non Nil but received %v  instead", got.UtilizationList)
...
func TestDelete(t *testing.T) {
	...
	require.LessOrEqual(t, len(got.UtilizationList), 0, "Expected non Nil but received %v  instead", got.UtilizationList)
}
