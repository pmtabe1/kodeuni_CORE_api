...
func TestAdd(t *testing.T) {
	...
	data := pos_models.AppStore{
		Foundation: base_models.Foundation{Model: gorm.Model{}, Name: "AppStore", Type: "AppStore", Stage: "added", Maker: "maker", Checker: "checker", Approver: "approver", Description: "AppStore", Status: "", WorkflowLevels: 0, SyncToken: 0, Version: 0, Enabled: 0, Locale: "", Events: []byte{}},
		AppList:    []*pos_models.App{},
	}
	data.ID = uint(ref)
	got := New().Add(&data)
	require.NotNilf(t, got.AppStore, "Expected non Nil but received %v  instead", got.AppStoreList)
...
func TestDelete(t *testing.T) {
	...
	require.LessOrEqual(t, len(got.AppStoreList), 0, "Expected non Nil but received %v  instead", got.AppStoreList)
}
