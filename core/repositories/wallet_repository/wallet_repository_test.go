...
func TestAdd(t *testing.T) {
	...
	data := pos_models.Wallet{
		Foundation: base_models.Foundation{Model: gorm.Model{}, Name: "Wallet", Type: "Wallet", Stage: "added", Maker: "maker", Checker: "checker", Approver: "approver", Description: "Wallet", Status: "", WorkflowLevels: 0, SyncToken: 0, Version: 0, Enabled: 0, Locale: "", Events: []byte{}},
	}
	data.ID = uint(ref)
	got := New().Add(&data)
	require.NotNilf(t, got.Wallet, "Expected non Nil but received %v  instead", got.WalletList)
...
func TestDelete(t *testing.T) {
	...
	require.LessOrEqual(t, len(got.WalletList), 0, "Expected non Nil but received %v  instead", got.WalletList)
}
