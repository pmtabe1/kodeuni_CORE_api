package consumption_repository
...
func TestAdd(t *testing.T) {
	...
	data := pos_models.Consumption{
		Foundation: base_models.Foundation{Model: gorm.Model{}, Name: "Consumption", Type: "Consumption", Stage: "added", Maker: "maker", Checker: "checker", Approver: "approver", Description: "Consumption", Status: "", WorkflowLevels: 0, SyncToken: 0, Version: 0, Enabled: 0, Locale: "", Events: []byte{}},
	}
	data.ID = uint(ref)
	got := New().Add(&data)
	require.NotNilf(t, got.Consumption, "Expected non Nil but received %v  instead", got.ConsumptionList)
...
func TestDelete(t *testing.T) {
	...
	require.LessOrEqual(t, len(got.ConsumptionList), 0, "Expected non Nil but received %v  instead", got.ConsumptionList)
}
