...
type IDepartmentRepository interface {
	Add(data pos_models.Department) (repository pos_models.DepartmentRepositoryResponse)
	Update(id uint, date pos_models.Department) (repository pos_models.DepartmentRepositoryResponse)
	AddOrUpdate(id int, data pos_models.Department) (repository pos_models.DepartmentRepositoryResponse)
	GetByID(id uint) (repository pos_models.DepartmentRepositoryResponse)
	GetByName(param string) (repository pos_models.DepartmentRepositoryResponse)
	GetByStage(param string) (repository pos_models.DepartmentRepositoryResponse)
	GetByType(param string) (repository pos_models.DepartmentRepositoryResponse)
	GetByDate(param string) (repository pos_models.DepartmentRepositoryResponse)
	GetByStatus(param int) (repository pos_models.DepartmentRepositoryResponse)
	GetByEnabled(param int) (repository pos_models.DepartmentRepositoryResponse)
	GetByLocale(param string) (repository pos_models.DepartmentRepositoryResponse)
	CheckIFExists(id uint) (repository pos_models.DepartmentRepositoryResponse)
	GetAll() (repository pos_models.DepartmentRepositoryResponse)
	Delete(id uint) (repository pos_models.DepartmentRepositoryResponse)
}
...
func (r *DepartmentRepository) Add(data *pos_models.Department) (repository pos_models.DepartmentRepositoryResponse) {
	...
	if data == nil {
		...
		repository.DepartmentList = make([]*pos_models.Department, 0)
...
func (r *DepartmentRepository) Update(id uint, data *pos_models.Department) (repository pos_models.DepartmentRepositoryResponse) {
	repository.RepositoryErrorResponse = new(error_models.ErrorModel)
...
func (r *DepartmentRepository) AddOrUpdate(id uint, data *pos_models.Department) (repository pos_models.DepartmentRepositoryResponse) {
...
func (r *DepartmentRepository) GetByID(id uint) (repository pos_models.DepartmentRepositoryResponse) {
...
func (r *DepartmentRepository) GetByOwnerRef(param string) (repository pos_models.DepartmentRepositoryResponse) {
	repository.RepositoryErrorResponse = new(error_models.ErrorModel)
...
func (r *DepartmentRepository) GetByBillID(id uint) (repository pos_models.DepartmentRepositoryResponse) {
	repository.RepositoryErrorResponse = new(error_models.ErrorModel)
...
func (r *DepartmentRepository) GetByTaxID(id uint) (repository pos_models.DepartmentRepositoryResponse) {
	repository.RepositoryErrorResponse = new(error_models.ErrorModel)
...
func (r *DepartmentRepository) GetByInvoiceID(id uint) (repository pos_models.DepartmentRepositoryResponse) {
	repository.RepositoryErrorResponse = new(error_models.ErrorModel)
...
func (r *DepartmentRepository) GetByReceiptID(id uint) (repository pos_models.DepartmentRepositoryResponse) {
	repository.RepositoryErrorResponse = new(error_models.ErrorModel)
...
func (r *DepartmentRepository) CheckIFExists(id uint) (repository pos_models.DepartmentRepositoryResponse) {
	repository.RepositoryErrorResponse = new(error_models.ErrorModel)
	err := r.GormDB.Find(&repository.DepartmentList, "id=?", id).Error
...
func (r *DepartmentRepository) GetAll() (repository pos_models.DepartmentRepositoryResponse) {
	repository.RepositoryErrorResponse = new(error_models.ErrorModel)
...
func (r *DepartmentRepository) Delete(id uint) (repository pos_models.DepartmentRepositoryResponse) {
	repository.RepositoryErrorResponse = new(error_models.ErrorModel)
	err := r.GormDB.Find(&repository.DepartmentList, "id=?", id).Error
...
func (r *DepartmentRepository) GetByName(param string) (repository pos_models.DepartmentRepositoryResponse) {
	repository.RepositoryErrorResponse = new(error_models.ErrorModel)
...
func (r *DepartmentRepository) GetByStage(param string) (repository pos_models.DepartmentRepositoryResponse) {
	repository.RepositoryErrorResponse = new(error_models.ErrorModel)
...
func (r *DepartmentRepository) GetByType(param string) (repository pos_models.DepartmentRepositoryResponse) {
	repository.RepositoryErrorResponse = new(error_models.ErrorModel)
...
func (r *DepartmentRepository) GetByDate(param string) (repository pos_models.DepartmentRepositoryResponse) {
	repository.RepositoryErrorResponse = new(error_models.ErrorModel)
...
func (r *DepartmentRepository) GetByStatus(param int) (repository pos_models.DepartmentRepositoryResponse) {
	repository.RepositoryErrorResponse = new(error_models.ErrorModel)
...
func (r *DepartmentRepository) GetByEnabled(param int) (repository pos_models.DepartmentRepositoryResponse) {
	repository.RepositoryErrorResponse = new(error_models.ErrorModel)
...
func (r *DepartmentRepository) GetByLocate(param string) (repository pos_models.DepartmentRepositoryResponse) {
	repository.RepositoryErrorResponse = new(error_models.ErrorModel)
