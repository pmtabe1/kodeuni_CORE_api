package invoice_item_repository
...
func TestAdd(t *testing.T) {
	...
	data := pos_models.InvoiceItem{
		Foundation: base_models.Foundation{Model: gorm.Model{}, Name: "InvoiceItem", Type: "InvoiceItem", Stage: "added", Maker: "maker", Checker: "checker", Approver: "approver", Description: "InvoiceItem", Status: "", WorkflowLevels: 0, SyncToken: 0, Version: 0, Enabled: 0, Locale: "", Events: []byte{}},
	}
	data.ID = uint(ref)
	got := New().Add(&data)
	require.NotNilf(t, got.InvoiceItem, "Expected non Nil but received %v  instead", got.InvoiceItemList)
...
func TestDelete(t *testing.T) {
	...
	require.LessOrEqual(t, len(got.InvoiceItemList), 0, "Expected non Nil but received %v  instead", got.InvoiceItemList)
}
