...
func TestAdd(t *testing.T) {
	...
	data := pos_models.Sale{
		Foundation: base_models.Foundation{Model: gorm.Model{}, Name: "Sale", Type: "Sale", Stage: "added", Maker: "maker", Checker: "checker", Approver: "approver", Description: "Sale", Status: "", WorkflowLevels: 0, SyncToken: 0, Version: 0, Enabled: 0, Locale: "", Events: []byte{}},
	}
	data.ID = uint(ref)
	got := New().Add(&data)
	require.NotNilf(t, got.Sale, "Expected non Nil but received %v  instead", got.SaleList)
...
func TestDelete(t *testing.T) {
	...
	require.LessOrEqual(t, len(got.SaleList), 0, "Expected non Nil but received %v  instead", got.SaleList)
}
