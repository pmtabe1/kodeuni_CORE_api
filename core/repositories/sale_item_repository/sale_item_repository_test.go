...
func TestAdd(t *testing.T) {
	...
	data := pos_models.SaleItem{
		Foundation: base_models.Foundation{Model: gorm.Model{}, Name: "SaleItem", Type: "SaleItem", Stage: "added", Maker: "maker", Checker: "checker", Approver: "approver", Description: "SaleItem", Status: "", WorkflowLevels: 0, SyncToken: 0, Version: 0, Enabled: 0, Locale: "", Events: []byte{}},
	}
	data.ID = uint(ref)
	got := New().Add(&data)
	require.NotNilf(t, got.SaleItem, "Expected non Nil but received %v  instead", got.SaleItemList)
...
func TestDelete(t *testing.T) {
	...
	require.LessOrEqual(t, len(got.SaleItemList), 0, "Expected non Nil but received %v  instead", got.SaleItemList)
}
