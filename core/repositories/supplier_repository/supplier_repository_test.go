...
func TestAdd(t *testing.T) {
	...
	data := pos_models.Supplier{
		Foundation: base_models.Foundation{Model: gorm.Model{}, Name: "Supplier", Type: "Supplier", Stage: "added", Maker: "maker", Checker: "checker", Approver: "approver", Description: "Supplier", Status: "", WorkflowLevels: 0, SyncToken: 0, Version: 0, Enabled: 0, Locale: "", Events: []byte{}},
	}
	data.ID = uint(ref)
	got := New().Add(&data)
	require.NotNilf(t, got.Supplier, "Expected non Nil but received %v  instead", got.SupplierList)
...
func TestDelete(t *testing.T) {
	...
	require.LessOrEqual(t, len(got.SupplierList), 0, "Expected non Nil but received %v  instead", got.SupplierList)
}
