...
func TestAdd(t *testing.T) {
	...
	data := pos_models.Shipping{
		Foundation: base_models.Foundation{Model: gorm.Model{}, Name: "Shipping", Type: "Shipping", Stage: "added", Maker: "maker", Checker: "checker", Approver: "approver", Description: "Shipping", Status: "", WorkflowLevels: 0, SyncToken: 0, Version: 0, Enabled: 0, Locale: "", Events: []byte{}},
	}
	data.ID = uint(ref)
	got := New().Add(&data)
	require.NotNilf(t, got.Shipping, "Expected non Nil but received %v  instead", got.ShippingList)
...
func TestDelete(t *testing.T) {
	...
	require.LessOrEqual(t, len(got.ShippingList), 0, "Expected non Nil but received %v  instead", got.ShippingList)
}
