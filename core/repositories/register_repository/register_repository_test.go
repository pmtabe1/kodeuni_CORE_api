...
func TestAdd(t *testing.T) {
	...
	data := pos_models.Register{
		Foundation: base_models.Foundation{Model: gorm.Model{}, Name: "Register", Type: "Register", Stage: "added", Maker: "maker", Checker: "checker", Approver: "approver", Description: "Register", Status: "", WorkflowLevels: 0, SyncToken: 0, Version: 0, Enabled: 0, Locale: "", Events: []byte{}},
	}
	data.ID = uint(ref)
	got := New().Add(&data)
	require.NotNilf(t, got.Register, "Expected non Nil but received %v  instead", got.RegisterList)
...
func TestDelete(t *testing.T) {
	...
	require.LessOrEqual(t, len(got.RegisterList), 0, "Expected non Nil but received %v  instead", got.RegisterList)
}
