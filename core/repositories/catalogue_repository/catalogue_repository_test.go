...
func TestAdd(t *testing.T) {
	...
	data := pos_models.Catalogue{
		Foundation: base_models.Foundation{Model: gorm.Model{}, Name: "Catalogue", Type: "Catalogue", Stage: "added", Maker: "maker", Checker: "checker", Approver: "approver", Description: "Catalogue", Status: "", WorkflowLevels: 0, SyncToken: 0, Version: 0, Enabled: 0, Locale: "", Events: []byte{}},
	}
	data.ID = uint(ref)
	got := New().Add(&data)
	require.NotNilf(t, got.Catalogue, "Expected non Nil but received %v  instead", got.CatalogueList)
...
func TestDelete(t *testing.T) {
	...
	require.LessOrEqual(t, len(got.CatalogueList), 0, "Expected non Nil but received %v  instead", got.CatalogueList)
}
