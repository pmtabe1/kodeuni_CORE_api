...
func TestAdd(t *testing.T) {
	...
	data := pos_models.TaxItem{
		Foundation: base_models.Foundation{Model: gorm.Model{}, Name: "TaxItem", Type: "TaxItem", Stage: "added", Maker: "maker", Checker: "checker", Approver: "approver", Description: "TaxItem", Status: "", WorkflowLevels: 0, SyncToken: 0, Version: 0, Enabled: 0, Locale: "", Events: []byte{}},
	}
	data.ID = uint(ref)
	got := New().Add(&data)
	require.NotNilf(t, got.TaxItem, "Expected non Nil but received %v  instead", got.TaxItemList)
...
func TestDelete(t *testing.T) {
	...
	require.LessOrEqual(t, len(got.TaxItemList), 0, "Expected non Nil but received %v  instead", got.TaxItemList)
}
